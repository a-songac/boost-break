...
public class ExerciseOLD implements Serializable {
	 ...
	 *
	 */
	public ExerciseOLD(String name, int duration, String description){
		this.name = name;
	...
	public String toString(){
		return "ExerciseOLD Name: " + name
				+ "\nExerciseOLD Duration: " + duration
				+ "\nExerciseOLD Description: " + description + "\n";
	}
